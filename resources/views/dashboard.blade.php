...
@role('reviewer')
    <div class="grid grid-cols-1 gap-6 md:grid-cols-3 p-4">
        <!-- Card 1 -->
        <div class="bg-white shadow-lg rounded-lg p-6 dark:bg-gray-800">
            <h3 class="text-lg font-semibold text-gray-800 dark:text-white">Card Title 1</h3>
            <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                This is the content of the first card. It can contain text or any other element.
            </p>
            <a href="#" class="mt-4 inline-block text-primary-500 hover:text-primary-700">
                Read More →
            </a>
        </div>
        ...
        <!-- Card 2 -->
        <div class="bg-white shadow-lg rounded-lg p-6 dark:bg-gray-800">
            <h3 class="text-lg font-semibold text-gray-800 dark:text-white">Card Title 2</h3>
            <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                This is the content of the second card. Feel free to customize it.
            </p>
            <a href="#" class="mt-4 inline-block text-primary-500 hover:text-primary-700">
                Read More →
            </a>
        ...
        <!-- Card 3 -->
        <div class="bg-white shadow-lg rounded-lg p-6 dark:bg-gray-800">
            <h3 class="text-lg font-semibold text-gray-800 dark:text-white">Card Title 3</h3>
            <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                This is the content of the third card. You can use icons, images, or more.
            </p>
            <a href="#" class="mt-4 inline-block text-primary-500 hover:text-primary-700">
                Read More →
            </a>
