            ...
            >
              ...
              >
                ...
                <div class="flex-auto p-4">
                    ...
                    <x-form-input action="{{ route('superadmin.typedokumen.update', ['typedokumen' => $typedokumen->id]) }}" method="POST">
                        @csrf
                        @method('PUT')
                    <x-input title="Nama Prodi" id="name" name="name" value="{{ $typedokumen->name }}" type="text" class="form-control" />
