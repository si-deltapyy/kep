            ...
            >
              ...
              >
                ...
                <div class="flex-auto p-4">
                  ...
                  <x-form-input action="{{ route('superadmin.typeajuan.update', ['typeajuan' => $typeajuan->id]) }}" method="POST">
                    @csrf
                    @method('PUT')

                    <x-input title="Type Ajuan" id="ajuan_name" name="ajuan_name" value="{{ $typeajuan->ajuan_name }}" type="text" class="form-control" />
