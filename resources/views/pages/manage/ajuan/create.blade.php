            ...
            >
              ...
              >
                ...
                <div class="flex-auto p-4">
                  ...
                  <x-form-input action="{{ route('superadmin.typeajuan.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <x-input title="Type Ajuan"  name="ajuan_name" id="ajuan_name"  type="text" class="form-control" />
                    <button
                      type="submit"
