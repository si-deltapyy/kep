            ...
            >
              ...
              >
                ...
                <div class="flex-auto p-4">
                  ...
                  <x-form-input action="{{ route('superadmin.prodi.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf

                    <x-input title="Nama Prodi"  name="name" id="name"  type="text" class="form-control" />
                    <x-input title="Kode Prodi" name="prodi_kode" id="prodi_kode" type="text" class="form-control" />
