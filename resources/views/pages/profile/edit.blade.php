                                    ...
                                    <div class="flex-auto p-4">
                                        <form action="{{route('user.profile.update', Auth::user()->id)}}" method="post">
                                            ...
                                            <div class="grid md:grid-cols-12 lg:grid-cols-12">
                                                ...
                                                <div class="col-span-12 md:col-span-12 lg:col-span-9 mb-2">
                                                    <input type="text" id="prodi" name="prodi" placeholder="Manajemen" class="form-input w-full rounded-md mt-1 border border-slate-300/60 dark:border-slate-700 dark:text-slate-300 bg-transparent px-3 py-1 focus:outline-none focus:ring-0 placeholder:text-slate-400/70 placeholder:font-normal placeholder:text-sm hover:border-slate-400 focus:border-primary-500 dark:focus:border-primary-500 dark:hover:border-slate-700" required>
                                                </div>

                                                <div class="col-span-12 md:col-span-12 lg:col-span-3 self-center text-right mr-2">
                                                    <label for="univ" class="font-medium text-sm text-slate-600 dark:text-slate-400">Universitas</label>
                                                </div>
                                                <div class="col-span-12 md:col-span-12 lg:col-span-9 mb-2">
                                                    <input type="text" id="univ" name="univ" placeholder="Universitas Sebelas Maret" class="form-input w-full rounded-md mt-1 border border-slate-300/60 dark:border-slate-700 dark:text-slate-300 bg-transparent px-3 py-1 focus:outline-none focus:ring-0 placeholder:text-slate-400/70 placeholder:font-normal placeholder:text-sm hover:border-slate-400 focus:border-primary-500 dark:focus:border-primary-500 dark:hover:border-slate-700" required>
                                                </div>
