    ...
    <div class="sm:col-span-12  md:col-span-12 lg:col-span-4 xl:col-span-3 ">
        <div class="bg-white dark:bg-gray-900 border border-slate-200 dark:border-slate-700/40  rounded-md w-full relative">
            <div class="flex-auto p-4 text-center">
                ...
                <h5 class="text-2xl font-semibold text-slate-700 dark:text-gray-400 leading-5">{{$d->title}} </h5>
                ...
                <p class="text-sm text-slate-600 font-medium block mb-3 mt-2"><span class="text-slate-700 dark:text-slate-400">Tanggal  :</span> {{$d->created_at}}</p>
                    <a href="{{ route('sekertaris.pesan.show', ['id' => $d->id]) }}">
