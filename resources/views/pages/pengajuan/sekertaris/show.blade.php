@extends('layouts.app')
@section('title')
    <x-page-tittle :title="'List Ajuan Ethical Clereance'" :slash1="'Daftar Ajuan'" :slash2="'List'"
                ...
                @if ($dums->doc_status != 'approved' && $dums->doc_status != 'on-review')
                    ...
                    <div id="accessModal"
                        ...
                        <div class="bg-white w-1/3 rounded-lg shadow-lg">
                            ...
                            <form action="{{ route('sekertaris.pengajuan.rejected', $dums->id) }}" method="POST">
                                @csrf
                                <div class="p-4 space-y-4">
                                    <p class="text-gray-700">
                                        Anda yakin ingin <strong>Menolak Dokumen</strong> pengajuan EC ini?
                                    </p>
                                ...
                                <div class="flex justify-end space-x-4 px-4 py-2">
                                    ...
                                    <button type="button" onclick="closeModal()"
                                            class="px-2 py-1 bg-green-500/10 border border-transparent text-green-700 text-sm rounded hover:bg-green-600 hover:text-white">
                                        <span>Kembali</span>
                                    </button>
                                </div>
                            </form>
