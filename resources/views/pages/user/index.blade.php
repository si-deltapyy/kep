        ...
        <div class="relative overflow-x-auto block w-full sm:px-6 lg:px-8">
            ...
            @php
                ...
                $actions1 = $user->mapWithKeys(function ($user) {
                    return [
                        $user->id => '
                        <form action="'. route('sekertaris.review.destroy', $user->id) .'" method="post">
                            ' . csrf_field() . '
                            ' . method_field("DELETE") . '
                        ...
                        <a href="'. route('sekertaris.review.edit', $user->id) .'" class="px-2 py-1 bg-blue-500/10 border border-transparent collapse:bg-blue-100 text-blue text-sm rounded hover:bg-blue-600 hover:text-white">Edit</a>
                    '
                    ];
                })->toArray();
            @endphp
