@extends('layouts.app')
@section('title')
<x-page-tittle :title="'User Create'" :slash1="'Administrator'" :slash2="'Reviewer'" :slash3="'Create'"></x-page-tittle>
            ...
            >
              ...
              >
                ...
                <div class="flex-auto p-4">
                  ...
                  <x-form-input action="{{route('superadmin.manage.sekertaris.store')}}" method="post">
                    @csrf
                    <x-input title="Nama" id="" value="" type="text" class="form-control" name="name"/>
                    <x-input title="Email" id="" value="" type="text" class="form-control" name="email"/>
                    <x-input title="Password" id="" value="" type="password" class="form-control" name="password"/>
