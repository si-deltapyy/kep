...
<div class="relative z-0 mb-2 w-full group">
    ...
    <input
        ...
        placeholder=" "
        {{ $attributes->merge([
            'class' => 'block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b border-slate-300/60 appearance-none dark:text-slate-300 dark:border-slate-700 dark:focus:border-primary-500 focus:outline-none focus:border-primary-500 peer',
        ]) }}
        @required(true)
    />
