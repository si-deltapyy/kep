...
<div id="accessModal"
    ...
    <div class="bg-white w-1/3 rounded-lg shadow-lg">
        ...
        <div class="p-4">
            <p class="text-gray-700">Silakan untuk mengunduh <strong>Template Pengajuan</strong> sesuai Dengan Bidang.
            </p>
        </div>
...
<div class="modal animate-ModalSlide hidden" id="modalcenter">
    <div
        ...
        <div
            ...
            <div
                class="flex shrink-0 items-center justify-between py-2 px-4 rounded-t border-b border-solid dark:border-gray-700 bg-[#603dc3] dark:bg-[#603dc3] dark:text-white text-white">
                <h6 class="mb-0 leading-4 text-base font-semibold text-white mt-0" id="staticBackdropLabel1">Unduh
                    Template</h6>
                <button type="button"
            ...
            <div data-fc-type="accordion">
                @foreach ($types as $type)
                    <h2 id="accordion-collapse-heading-1" class="bg-white" data-fc-type="collapse">
                        <button type="button"
                                class="fc-collapse-open:text-primary flex justify-between items-center p-5 w-full font-medium text-left text-gray-500 rounded-t-xl border border-b-0 border-gray-200  dark:border-gray-700 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800"
                                data-accordion-target="#accordion-collapse-body-1" aria-expanded="true"
                                aria-controls="accordion-collapse-body-1">
                            <span>Template {{ $type->ajuan_name }}</span>
                            <i class="fas fa-angle-down  fc-collapse-open:rotate-180 transition-transform duration-300"
                               data-accordion-icon></i>
                        </button>
                    </h2>
                    <div id="accordion-collapse-body-1" class="hidden overflow-hidden transition-[height] duration-300"
                            ...
                            <ul>
                                @foreach($type->template as $template)
                                    <li>
                                        ...
                                        <a href="{{ asset('/app/' . $template->template_path) }}"
                                           class="inline-block focus:outline-none text-primary-500 hover:bg-primary-500 hover:text-white bg-transparent border border-gray-200 dark:bg-transparent dark:text-primary-500 dark:hover:text-white dark:border-gray-700 dark:hover:bg-primary-500  text-sm font-medium py-1 px-3 rounded mr-1 close"
                                           data-fc-dismiss>Unduh</a>
                                    </li>
                                @endforeach
                            </ul>
                        </div>
