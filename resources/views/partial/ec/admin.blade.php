<div class="col-span-12 sm:col-span-12 md:col-span-12 lg:col-span-8 xl:col-span-9">
    ...
    @else
        @foreach ($doc as $x)
                ...
                <div>
                    <div class="active p-4 bg-gray-50 rounded-lg dark:bg-gray-700/20">
                        ...
                        @if ($x->ec_status == 'Waiting Sign KPPM')
                            @if ($x->ethical_number==null)
                                <button
                                    type="button"
                                    data-fc-type="modal"
                                    data-fc-target="modal-primary-{{$x->id}}"
                                    data-id="{{$x->id}}"
                        ...
                        @elseif($x->ec_status == 'Signed')
                            <a href="{{route('admin.ec.publish', $x->id)}}"
                        ...
                        @elseif($x->ec_status == 'Process')
                            ...
                            <button
                                type="button"
                                data-fc-type="modal"
                                data-fc-target="modal-edit-{{$x->id}}"
                                data-id="{{$x->id}}"
                                class="px-2 py-1 lg:px-4 bg-transparent text-primary text-sm rounded transition hover:bg-primary-500 hover:text-white border border-primary font-medium"
                            >
                                Beri Penomoran Ethical Clearence
            ...
            <div class="modal animate-ModalSlide hidden" id="modal-primary-{{$x->id}}">
                <div
                    ...
                    <div
                        ...
                        <div
                            ...
                            <h6 class="mb-0 leading-4 text-base font-semibold text-slate-300 mt-0"
                                id="staticBackdropLabel1">Input Ethical Number</h6>
                            <button type="button"
                        ...
                        <div class="relative flex-auto p-4 text-slate-600 dark:text-gray-300 leading-relaxed">
                            <form action="{{route('admin.ec.reqSign', $x->id)}}" method="POST">
                                ...
                                <x-input title="Masukan Ethical Number (…../UN27.02.11/PP/EC/202…)"
                                         value="…../UN27.02.11/PP/EC/202…" id="ethical_number" name="ethical_number"
                                         type="text" class="form-control"/>

                                <div class="flex flex-wrap shrink-0 justify-end p-3 rounded-b border-t border-dashed">
                                    <button type="button"
                                            class="inline-block text-red-500 hover:bg-red-500 hover:text-white border border-gray-200 text-sm font-medium py-1 px-3 rounded mr-1 close"
                                            data-fc-dismiss>Close
                                    </button>
                                    <button type="submit"
                                            class="inline-block text-primary-500 hover:bg-primary-500 hover:text-white border border-gray-200 text-sm font-medium py-1 px-3 rounded">
                                        Submit
                                    </button>
                                </div>
                            </form>
            ...
            <div class="modal animate-ModalSlide hidden" id="modal-edit-{{$x->id}}">
                <div
                    class="relative w-auto pointer-events-none sm:max-w-lg sm:my-0 sm:mx-auto z-[99] flex items-center h-[calc(100%-3.5rem)]">
                    <div
                        class="relative flex flex-col w-full pointer-events-auto bg-white dark:bg-slate-800 bg-clip-padding rounded">
                        ...
                        <div class="relative flex-auto p-4 text-slate-600 dark:text-gray-300 leading-relaxed">
                            <form action="{{route('admin.ec.reqSign', $x->id)}}" method="POST">
                                ...
                                <input type="text" id="data-id" hidden>
                                <x-input title="Masukan Ethical Number (…../UN27.02.11/PP/EC/202…)"
                                         value="{{$x->ethical_number}}" id="ethical_number" name="ethical_number"
                                         type="text" class="form-control"/>
