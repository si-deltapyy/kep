...
@if (session('error'))
    <div id="errorAlert" class="bg-red-100 border-l-4 border-red-500 text-red-700 p-4 rounded-md shadow-lg mb-4 relative" role="alert">
        <div class="flex items-center">
            <div class="mr-3">
                <span data-lucide="alert-circle" class="w-6 h-6 text-red-500"></span>
            </div>
            <div>
        ...
        <button type="button" onclick="closeAlert('errorAlert')" class="absolute top-2 right-2 text-red-500 hover:text-red-700 focus:outline-none">
...
<div class="grid grid-cols-1 md:grid-cols-3 gap-6 p-4">
    ...
    <div class="bg-white shadow-lg rounded-lg p-6 flex items-center dark:bg-gray-800">
        ...
        <div class="ml-5">
            ...
            <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">Dokumen proses Review</p>
        </div>
    </div>

    <div class="bg-white shadow-lg rounded-lg p-6 flex items-center dark:bg-gray-800">
        <div class="p-4 bg-green-500/10 rounded-full text-green-500 dark:bg-purple-400/20 dark:text-green-400">
            <span data-lucide="file-check" class="w-10 h-10 inline-block "></span>
        </div>
        <div class="ml-5">
            <h3 class="text-lg font-semibold text-gray-800 dark:text-white">Dokumen Selesai</h3>
            <p class="mt-2 text-3xl font-bold text-green-500 dark:text-green-400">{{ $sekcount['done'] }}</p>
            <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">Dokumen telah selesai</p>
        </div>
    </div>
