    ...
    <div class="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded relative alert" role="alert">
        ...
        <button type="button" role="button" class="absolute top-0 bottom-0 right-0 px-4 py-3">
            <svg class="fill-current h-6 w-6 text-green-500" role="button" xmlns="http://www.w3.org/2000/svg"
                ...
                <title>Close</title>
                <path
                    d="M14.348 5.652a1 1 0 00-1.414 0L10 8.586 7.066 5.652a1 1 0 00-1.414 1.414L8.586 10l-2.934 2.934a1 1 0 101.414 1.414L10 11.414l2.934 2.934a1 1 0 101.414-1.414L11.414 10l2.934-2.934a1 1 0 000-1.414z"/>
            </svg>
        </button>
    </div>
@endif
        ...
        <div class="col-span-12">
            <div class="w-full relative overflow-hidden bg-white dark:bg-slate-800 shadow-md rounded-lg">
                <div class="border-b border-dashed border-slate-200 dark:border-slate-700 py-4 px-6">
                    ...
                    <center>
                        <a href="{{route('user.profile.make', Auth::user()->id)}}"
                           class="text-center px-2 py-1 bg-primary-500/10 border border-transparent collapse:bg-green-100 text-primary text-sm rounded hover:bg-blue-600 hover:text-white">
...
@can('approved')
    <div class="bg-white shadow-lg rounded-lg p-6 flex items-center dark:bg-gray-800">
        <div class="ml-5">
            <h3 class="text-lg font-semibold text-gray-800 dark:text-white">Menunggu Konfirmasi Akun dari Admin KEP FKIP
                UNS</h3>
